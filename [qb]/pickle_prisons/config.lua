...
Config.Prisons = {
    ["default"] = { -- Default is used as the prison location for players when not defined otherwise.
        ...
        release = {
            coords = vector3(1846.46, 2585.83, 45.67),
            heading = 275.19
        },
        breakout = {
            start = {
        ...
        activities = {
            {
                ...
                coords = vector3(1737.55, 2494.17, 44.85),
                heading = 121.90,
                randomSection = true, -- Chooses random section when true, or top-to-bottom when false.
                sections = {
                    {
                        name = "lift",
                        coords = vector3(1734.32, 2498.18, 45.85),
                        heading = 129.59
                    },
                    {
                        name = "situp",
                        coords = vector3(1729.31, 2496.88, 45.84),
                        heading = 300.44
                    },
                    {
                        name = "pushup",
                        coords = vector3(1734.21, 2490.43, 45.83),
                        heading = 27.79
                    },
                    {
                        name = "pullup",
            ...
            },
            {
                name = "clean",
                model = {hash = `u_m_y_prisoner_01`},
                coords = vector3(1782.46, 2502.00, 44.85),
                heading =  123.47,
                randomSection = true, -- Chooses random section when true, or top-to-bottom when false.
                sections = {
                    {
                        name = "sweep",
                        coords = vector3(1770.02, 2506.83, 45.85), -- Location of the cell.
                        heading = 207.8018, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "sweep",
                        coords = vector3(1758.69, 2499.41, 49.24), -- Location of the cell.
                        heading = 207.8018, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "sweep",
                        coords = vector3(1747.68, 2468.87, 49.24), -- Location of the cell.
                        heading = 207.8018, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "sweep",
                    ...
                    {
                        name = "sweep",
                        coords = vector3(1763.64, 2479.05, 45.85), -- Location of the cell.
                        heading = 207.8018, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "sweep",
                        coords = vector3(1747.70, 2493.26, 45.84), -- Location of the cell.
                        heading = 207.8018, -- Direction to face the player upon spawn.
                    },
                }
            },
            {
                ...
                coords = vector3(1789.19, 2565.16, 44.62),
                heading = 106.11,
                randomSection = false, -- Chooses random section when true, or top-to-bottom when false.
                sections = {
                    {
                        name = "stock",
                        coords = vector3(1786.06, 2567.75, 45.62), -- Location of the cell.
                        heading = 1.83, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "cook",
                        coords = vector3(1782.75, 2566.51, 45.62), -- Location of the cell.
                        heading = 181.33, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "toppings",
                        coords = vector3(1779.81, 2564.74, 45.62), -- Location of the cell.
                        heading = 273.82, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "delivery",
                        coords = vector3(1784.81, 2550.79, 45.62), -- Location of the cell.
                        heading = 153.16, -- Direction to face the player upon spawn.
                    },
                }
            },
        },
        ...
        stores = {
            {
                ...
                coords = vector3(1777.92, 2557.71, 45.62),
                heading = 183.40,
                model = {hash = `s_m_y_chef_01`},
                catalog = {
                    {
        ...
        lootables = {
            {
                ...
                coords = vector3(1775.48, 2548.15, 45.59),
                heading = 59.00,
            ...
            {
                label = "Metal",
                coords = vector3(1732.31, 2502.27, 45.85),
                heading = 326.06,
            ...
            {
                label = "Rope",
                coords = vector3(1590.44, 2560.54, 55.19),
                heading = 89.57,
