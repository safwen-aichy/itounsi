...
Config.ChargePerTattoo = 0 -- Charge players per tattoo. Config.TattooCost will become the cost of 1 tattoo. The cost can be overridden by adding `cost` key in shared/tattoos.lua for specific tattoos
...
Config.Stores = {
    ...
    {
        type = "clothing",
        coords = vector4(-332.73, 7209.49, 6.8, 196.12),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-332.29, 7209.75, 6.8),
            vector3(-331.97, 7214.68, 6.81),
            vector3(-340.51, 7213.57, 6.8)
        }
    },
    {
        type = "barber",
...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(601.12, 12.54, 82.74, 219.39),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "ambulance",
        coords = vector4(-438.93, -307.94, 34.91, 221.66),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
        ...
        {
        job = "burgershot",
        coords = vector4(-1204.06, -893.87, 13.89, 219.39),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-1202.92, -894.10, 13.89),
            vector3(-1203.72, -892.74, 13.89),
            vector3(-1205.10, -894.28, 13.89),
            vector3(-1204.78, -895.37, 13.89)
        }
    },
    {
        job = "burgershot",
    ...
    {
        job = "bio",
        coords = vector4(3549.67, 3661.97, 28.12, 78.14),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = false
    ...
    ["police"] = {
        ["Male"] = {
            ...
            },
            {
                name = "Haras",
                outfitData = {
                   ["pants"] = {item = 141, texture = 0}, -- Pants
                    ["arms"] = {item =20, texture = 0}, -- Arms
                    ["t-shirt"] = {item = 211, texture = 0}, -- T Shirt
                    ["vest"] = {item = 0, texture = 0}, -- Body Vest
                    ["torso2"] = {item = 93, texture =0}, -- Jacket
                    ["shoes"] = {item = 225, texture = 1}, -- Shoes
                    ["accessory"] = {item = 0, texture = 0}, -- Neck Accessory
                    ["bag"] = {item = 0, texture = 0}, -- Bag
                    ["hat"] = {item = 14, texture = 3}, -- Hat
                    ["glass"] = {item = 0, texture = 0}, -- Glasses
                    ["mask"] = {item = 0, texture = 0} -- Mask-- Mask
                },
                grades = {0, 1, 2, 3, 4},
            },
            {
        ...
        ["Male"] = {
            {
                ...
                name = "Worker",
                outfitData = {
                   ["pants"] = {item = 64, texture = 6}, -- Pants
                    ["arms"] = {item = 0, texture = 0}, -- Arms
                    ["t-shirt"] = {item = 15, texture = 0}, -- T Shirt
                    ["vest"] = {item = 0, texture = 0}, -- Body Vest
                    ["torso2"] = {item = 282, texture = 2}, -- Jacket
                    ["shoes"] = {item = 225, texture = 1}, -- Shoes
                    ["accessory"] = {item = 0, texture = 0}, -- Neck Accessory
                    ["bag"] = {item = 0, texture = 0}, -- Bag
                    ["hat"] = {item = 14, texture = 3}, -- Hat
