...
Config.Discord = {
    ...
    applicationId = '1432638941378641984',                   -- The discord application id
    iconLarge = 'itounsi',                               -- The name of the large icon
    iconLargeHoverText = 'iTounsi Roleplay', -- The hover text of the large icon
    ...
    maxPlayers = 256,                                       -- Maximum amount of players
    buttons = {
        {
            text = 'Play!',
            url = 'fivem://connect/itounsi.online:30150'
        },
        {
            text = 'join Server!',
            url = 'fivem://connect/itounsi.online:30150'
...
Config.Disable = {
    ...
    hudComponents = { 1, 2, 3, 4, 7, 9, 13, 19, 20, 21, 22 }, --WITH CROSSHAIR  Hud Components: https://docs.fivem.net/natives/?_0x6806C51AD12B83B8
...
Config.Consumables = {
    eat = { -- default food items
        ['sandwich'] = math.random(7, 9),
        ['tosti'] = math.random(7, 9),
        ['twerks_candy'] = math.random(7, 9),
        --Burger Shot Eat
