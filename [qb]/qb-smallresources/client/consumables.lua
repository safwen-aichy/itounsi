...
--Threads
-- Add this function to your consumables script
        ...
        CreateThread(function()
            while true do
                ...
                if alcoholCount > 0 then
                    alcoholEffect() -- Apply visual effects based on alcoholCount
                    Wait(1000 * 60 * 0.2)
                    alcoholCount -= 1
                else
                    alcoholEffect() -- Clear effects when sober
                    looped = false
                    break
                end
            end
