...
Config.PlayersNumberOfCharacters = { -- Define maximum amount of player characters by rockstar license (you can find this license in your server's database in the player table)
    { license = "license:83fe82e1cde9ce912dccc4087e18d0fc7aa80396", numberOfChars = 2 },
    { license = "license:f931476dbc870674c6e98cb5bb3e51d2e0dd7bd1", numberOfChars = 4},
    { license = "license:dbf1ade361056f5e6bd50366b272d673aac458f4", numberofChars = 2 },
