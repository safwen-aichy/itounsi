...
local Vehicles = {
    --- Compacts (0)
    {
        ...
        price = 16000,          -- The price that the vehicle sells for
    ...
    { model = 'blista',          name = 'Blista',                        brand = 'Dinka',           price = 15000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'brioso',          name = 'Brioso R/A',                    brand = 'Grotti',          price = 38000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'club',            name = 'Club',                          brand = 'BF',              price = 59000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'dilettante',      name = 'Dilettante',                    brand = 'Karin',           price = 14000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'kanjo',           name = 'Blista Kanjo',                  brand = 'Dinka',           price = 98000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi2',           name = 'Issi',                          brand = 'Weeny',           price = 53000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi3',           name = 'Issi Classic',                  brand = 'Weeny',           price = 55000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'panto',           name = 'Panto',                         brand = 'Benefactor',      price = 9000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'prairie',         name = 'Prairie',                       brand = 'Bollokan',        price = 61000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'rhapsody',        name = 'Rhapsody',                      brand = 'Declasse',        price = 21000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'brioso2',         name = 'Brioso 300',                    brand = 'Grotti',          price = 65000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'weevil',          name = 'Weevil',                        brand = 'BF',              price = 80000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi7',           name = 'Issi Sport',                    brand = 'Weeny',           price = 280000,  category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'blista2',         name = 'Blista Compact',                brand = 'Dinka',           price = 38000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'brioso3',         name = 'Brioso 300 Widebody',           brand = 'Grotti',          price = 220000,  category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'boor',            name = 'Boor',                          brand = 'Karin',           price = 90000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    --- Sedans (1)
    { model = 'asea',            name = 'Asea',                          brand = 'Declasse',        price = 12000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'asterope',        name = 'Asterope',                      brand = 'Karin',           price = 21000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'cog55',           name = 'Cognoscenti 55',                brand = 'Enus',            price = 210000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'cognoscenti',     name = 'Cognoscenti',                   brand = 'Enus',            price = 250000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'emperor',         name = 'Emperor',                       brand = 'Albany',          price = 32500,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'fugitive',        name = 'Fugitive',                      brand = 'Cheval',          price = 57000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'glendale',        name = 'Glendale',                      brand = 'Benefactor',      price = 45000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'glendale2',       name = 'Glendale Custom',               brand = 'Benefactor',      price = 62000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'ingot',           name = 'Ingot',                         brand = 'Vulcar',          price = 18000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'intruder',        name = 'Intruder',                      brand = 'Karin',           price = 48000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'premier',         name = 'Premier',                       brand = 'Declasse',        price = 32000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'primo',           name = 'Primo',                         brand = 'Albany',          price = 18000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'primo2',          name = 'Primo Custom',                  brand = 'Albany',          price = 52000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'regina',          name = 'Regina',                        brand = 'Dundreary',       price = 14000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stafford',        name = 'Stafford',                      brand = 'Enus',            price = 285000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stanier',         name = 'Stanier',                       brand = 'Vapid',           price = 42000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stratum',         name = 'Stratum',                       brand = 'Zirconium',       price = 25000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'superd',          name = 'Super Diamond',                 brand = 'Enus',            price = 120000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'surge',           name = 'Surge',                         brand = 'Cheval',          price = 37000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'tailgater',       name = 'Tailgater',                     brand = 'Obey',            price = 70000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'warrener',        name = 'Warrener',                      brand = 'Vulcar',          price = 75000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'washington',      name = 'Washington',                    brand = 'Albany',          price = 62000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'tailgater2',      name = 'Tailgater S',                   brand = 'Obey',            price = 174000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'cinquemila',      name = 'Lampadati',                     brand = 'Cinquemila',      price = 300000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'iwagen',          name = 'Obey',                          brand = 'I-Wagen',         price = 315000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'astron',          name = 'Astron',                        brand = 'Pfister',         price = 310000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'baller7',         name = 'Baller ST',                     brand = 'Gallivanter',     price = 320000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'comet7',          name = 'Comet',                         brand = 'S2 Cabrio',       price = 680000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'deity',           name = 'Deity',                         brand = 'Enus',            price = 600000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'jubilee',         name = 'Jubilee',                       brand = 'Enus',            price = 625000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'oracle',          name = 'Oracle',                        brand = 'Übermacht',       price = 112000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'schafter2',       name = 'Schafter',                      brand = 'Benefactor',      price = 95000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'warrener2',       name = 'Warrener HKR',                  brand = 'Vulcar',          price = 80000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'rhinehart',       name = 'Rhinehart',                     brand = 'Übermacht',       price = 245000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'asterope2',       name = 'Asterope GZ',                   brand = 'Karin',           price = 135000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'impaler5',        name = 'Impaler SZ',                    brand = 'Declasse',        price = 85000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    --- SUV (2)
    { model = 'baller',          name = 'Baller',                        brand = 'Gallivanter',     price = 120000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller2',         name = 'Baller II',                     brand = 'Gallivanter',     price = 250000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller3',         name = 'Baller LE',                     brand = 'Gallivanter',     price = 315000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller4',         name = 'Baller LE LWB',                 brand = 'Gallivanter',     price = 325000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'bjxl',            name = 'BeeJay XL',                     brand = 'Karin',           price = 90000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'cavalcade',       name = 'Cavalcade',                     brand = 'Albany',          price = 115000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'cavalcade2',      name = 'Cavalcade II',                  brand = 'Albany',          price = 165000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'contender',       name = 'Contender',                     brand = 'Vapid',           price = 355000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'dubsta',          name = 'Dubsta',                        brand = 'Benefactor',      price = 140000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'dubsta2',         name = 'Dubsta Luxury',                 brand = 'Benefactor',      price = 235000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'fq2',             name = 'FQ2',                           brand = 'Fathom',          price = 145000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'gresley',         name = 'Gresley',                       brand = 'Bravado',         price = 115000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'huntley',         name = 'Huntley S',                     brand = 'Enus',            price = 112000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'landstalker2',    name = 'Landstalker XL',                brand = 'Dundreary',       price = 185000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'novak',           name = 'Novak',                         brand = 'Lampadati',       price = 285000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'patriot',         name = 'Patriot',                       brand = 'Mammoth',         price = 210000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'rebla',           name = 'Rebla GTS',                     brand = 'Übermacht',       price = 315000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'seminole2',       name = 'Seminole Frontier',             brand = 'Canis',           price = 170000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'toros',           name = 'Toros',                         brand = 'Pegassi',         price = 550000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'xls',             name = 'XLS',                           brand = 'Benefactor',      price = 257000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'baller8',         name = 'Baller ST-D',                   brand = 'Gallivanter',     price = 450000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'cavalcade3',      name = 'Cavalcade XL',                  brand = 'Albany',          price = 287000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'dorado',          name = 'Dorado',                        brand = 'Bravado',         price = 289000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
