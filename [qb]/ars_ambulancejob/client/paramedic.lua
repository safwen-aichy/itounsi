        ...
        options = {
            {
                ...
                onSelect = function()
                    ...
                    if money >= Config.ParamedicTreatmentPrice then
                        ...
                        lib.progressBar({
                            duration = 15000,
                            label = locale("getting_treated"),
                            useWhileDead = false,
                            canCancel = true,
                            disable = { car = true, move = true },
                        })

                        TriggerServerEvent('ars_ambulancejob:server:respawnPlayer')
                        TriggerEvent('ars_ambulancejob:client:respawnPlayer')
                        ...
                        TriggerServerEvent('QBCore:Server:SetMetaData', 'inlaststand', false)
